...
# Mismo motivo que el init check: modo transacción de PgBouncer no soporta DDL/advisory locks.
...
# --- Init check: directo a postgres:5432, no PgBouncer ---
...
# --- Entrypoint oficial: wait-for-psql + --db_host/etc hacia PgBouncer ---

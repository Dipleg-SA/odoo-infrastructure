...
Con DNS-01 no hace falta que nginx esté vivo para emitir: la validación va contra la API de Cloudflare, no contra el puerto 80. Ver [levantar-produccion](../../entorno/levantar-produccion.md), bloque 3 · Edge.

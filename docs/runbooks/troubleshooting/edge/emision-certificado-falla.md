...
- Si falla por **validación** y no por credencial, subí `ACME_PROPAGATION_SECONDS` en `.env`: certbot está pidiendo la verificación antes de que el registro TXT haya propagado.

...
`docker/compose.yaml` usa la directiva `include:`, que exige Compose ≥ 2.20 — versiones más viejas fallan al resolver la composición, no al arrancar un contenedor.

...
|------------------------------------------------------------------------|-----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Tags `local/odoo:local`, `local/postgres:local`, `local/dnsmasq:local` | Todos                       | **El `build` de uno pisa la imagen que corre el otro.** Es el punto más filoso: no falla, no avisa, y el síntoma aparece en el siguiente `up -d` de producción                                                          |
